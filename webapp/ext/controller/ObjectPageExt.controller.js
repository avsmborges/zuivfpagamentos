sap.ui.define([
    ...
    "br/com/dellavolpe/zuivfpagamentos/model/ErrorHandler",
    "sap/m/MessageToast"
    ...
    return {
        ...
        onInit: function (oEvt) {
            ...
            Fragment.load({
                name: "br.com.dellavolpe.zuivfpagamentos.fragment.MeioPagamento"
        ...
        _onPageDataLoaded: function (oEvt) {
            this._innerTable = this._oView.byId("br.com.dellavolpe.zuivfpagamentos::sap.suite.ui.generic.template.ObjectPage.view.Details::ValeFretePagamentos--Valores::responsiveTable");
